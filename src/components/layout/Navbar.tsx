...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex lg:items-center lg:gap-3">
              ...
              <button
                ...
                className="relative flex items-center justify-center w-10 h-10 rounded-lg hover:bg-muted transition-colors text-muted-foreground hover:text-foreground"
      ...
      {/* Cart Drawer — rendered outside nav to avoid z-index issues */}
      <CartDrawer />
    </>
  );
};
